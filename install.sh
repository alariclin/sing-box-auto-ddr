...
while true; do
    ...
    echo -e " ${GREEN}12.${NC} VPS一键优化（bbr） / VPS One-Click Tuning"
    echo -e " ${GREEN}13.${NC} 全部节点参数显示 / Display Node Config"
    echo -e " ${GREEN}14.${NC} 脚本说明书 / Script Manual"
    echo -e " ${GREEN}15.${NC} 脚本OTA升级 / Script OTA Update"
    echo -e " ${GREEN}16.${NC} 一键全部清空卸载 / One-Click Uninstall"
    echo -e " ${GREEN}17.${NC} 删除所有节点与环境初始化 / Environment Auto-Fix"
